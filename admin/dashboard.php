                    ...
                    <div class="col-md-4">
                        <div class="card-box h-100">
                            <div class="card-header">
                                ...
                                <span class="d-block mb-4 text-nowrap">Freelancer from sudan</span>
                            </div>
                            <br><br>
                            ...
                            <div class="card-body">
                                <div class="row ">
                                    <div class="col-md-6">
                                        ...
                                        <small class="d-block mb-3">In <br>PHP, Laravel, c++, and Etc.</small>
                                        <br>
                                        <br>
                                        <a href="http://localhost/whitenile24/" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                                    </div>
                                    <div class="col-md-6">
