        ...
        <div class="row" style="margin-top: 4%">
            ...
            <div class="col-md-2 mt-4">
                ...
                <div class="card my-4 border-0">
                    <h5 class="card-header bg-white border-0">البرامج</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="col-md-7" dir="ltr">
                <h4 class="widget-title mb-4">اهم <span>احداث اليوم</span></h4>
                <!-- Blog Post -->
                <div class="row">
                    <div class="owl-carousel owl-theme" id="slider">
                        <div class="card mb-4 border-0">
                            <img class="card-img-top" src="images/20.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                                ...
                                <p class="m-0"><small> Posted on 2024-11-11 00:20:09</small></p>
                                <a href="#" class="card-title text-decoration-none text-dark">
                                    <h5 class="card-title">#جامعة_النيل_الأبيض_تحتفل_باليوبيلها_الفضي_( سبتمبر 1999 - 2024)</h5>
                                </a>
                                <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid']) ?>" class="">Read More &rarr;</a> -->
                            </div>
                        </div>
                        <div class="card mb-4 border-0">
                            <img class="card-img-top" src="images/23.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                                    <a class="badge bg-success text-decoration-none link-light" href="#" style="color:#fff">Sports</a>
                                ...
                                <a href="#" class="card-title text-decoration-none text-dark">
                                    <h5 class="card-title">الدفعة 24 مختبرات طبية 🔬🧫..
                                        #الخريجين_بإذن_الله 🤍🎓..</h5>
                                </a>
                                <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid']) ?>" class="">Read More &rarr;</a> -->
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4 mt-5 border-0">
                            <img class="card-img-top" src="images/21.jpg" alt="" width="100%">
                            <div class="card-body">
                                <p class="m-0">
                                    <!--category-->
                                    <a class="badge bg-success text-decoration-none link-light" href="#" style="color:#fff">Sports</a>
                                ...
                                <p class="m-0"><small> Posted on 2022-11-11 00:20:09</small></p>
                                <a href="#" class="card-title text-decoration-none text-dark">
                                    <h5 class="card-title">بيان رسمي</h5>
                                </a>
                                <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid']) ?>" class="">Read More &rarr;</a> -->
                            </div>
                        </div>
