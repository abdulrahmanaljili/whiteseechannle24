    ...
    <div class="container-fluid">
            ...
            <div class="col-md-9 mt-5">
                ...
                ?>
                    <div class="card border-0">
                        ...
                        <?php endif; ?>
                        <p><strong>Share:</strong> <a href="https://www.facebook.com/whitesea24/<?php echo $currenturl; ?>" target="_blank">Facebook</a> |
        ...
        <div class="col-md-8"  >
            ...
            <div class="card my-4 bg-transparent border-0">
                <h5  class="card-header bg-transparent border-0">اترك تعليق</h5>
                <div class="card-body">
                    <form name="Comment" method="post">
                        <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>" />
                        <div class="form-group">
                            <input type="text" name="name" class="form-control rounded-0" placeholder="ادخل إسمك كاملاً" required>
                        </div>
                        <div class="form-group">
                            <input type="email" name="email" class="form-control rounded-0" placeholder="ادخل إيميلك الشخصي" required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control rounded-0" name="comment" rows="3" placeholder="تعليق..." required></textarea>
                        </div>
                        <button type="submit" class="btn btn-danger" name="submit">إرسال</button>
                    </form>
                </div>
            </div>
        </div>
